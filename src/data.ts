...
export const players: Player[] = [
  ...
  createTBDPlayer({
    ...
    dob: "2007",
    nationality: "Greece",
    currentTeam: "GS Kronos Agiou Dimitriou",
    league: "International",
    roleTag: "Low Usage / Role Player / Size",
    scoutingLine: "Played FIBA U18 EuroBasket 2025; limited offensive role, low efficiency, mostly rotation minutes.",
    background: [
    ...
    physicalProfile: [
      "Height: 178cm (5'10\")",
      "Solid frame for a wing/forward",
      "Rotation-level mobility"
    ],
    offensiveProfile: [
      "Low usage role player",
      "Limited offensive production (2.9 PPG)",
      "Developing shooting consistency (29.2% FG)"
    ],
    defensiveProfile: [
      "Active rotation defender",
      "Contributes on the glass (2.3 RPG)"
    ],
    projection: {
      level: "NCAA D1 (Low-Major) / International",
      role: "Rotation Forward / Role Player",
      limitation: "Offensive efficiency"
    },
    synergyStats: [
      { category: "Overall", poss: 38, pctPoss: "100.0%", ppp: 0.526, rank: "24%", rating: "Below Average", fgm: 7, fga: 24, fgPct: 29.2 },
      { category: "Transition", poss: 6, pctPoss: "15.8%", ppp: 0.667, rank: "-", rating: "-", fgm: 2, fga: 4, fgPct: 50.0 },
      { category: "Overall Half Court", poss: 32, pctPoss: "84.2%", ppp: 0.500, rank: "26%", rating: "Below Average", fgm: 5, fga: 20, fgPct: 25.0 },
      { category: "Post Up", poss: 3, pctPoss: "9.4%", ppp: 0.667, rank: "-", rating: "-", fgm: 1, fga: 2, fgPct: 50.0 },
      { category: "Spot Up", poss: 2, pctPoss: "6.3%", ppp: 1.000, rank: "-", rating: "-", fgm: 1, fga: 2, fgPct: 50.0 },
      { category: "P&R Ball Handler", poss: 2, pctPoss: "6.3%", ppp: 1.000, rank: "-", rating: "-", fgm: 1, fga: 1, fgPct: 100.0 },
      { category: "Cut", poss: 4, pctPoss: "12.5%", ppp: 0.000, rank: "-", rating: "-", fgm: 0, fga: 2, fgPct: 0.0 },
      { category: "Against Man", poss: 30, pctPoss: "93.8%", ppp: 0.533, rank: "30%", rating: "Below Average", fgm: 5, fga: 18, fgPct: 27.8 },
      { category: "Against Zone", poss: 2, pctPoss: "6.3%", ppp: 0.000, rank: "-", rating: "-", fgm: 0, fga: 2, fgPct: 0.0 },
      { category: "After Time Outs", poss: 9, pctPoss: "23.7%", ppp: 0.111, rank: "-", rating: "-", fgm: 0, fga: 4, fgPct: 0.0 },
      { category: "Out of Bounds", poss: 1, pctPoss: "11.1%", ppp: 0.000, rank: "-", rating: "-", fgm: 0, fga: 0, fgPct: 0.0 },
      { category: "Last 4 Sec. of Shot Clock", poss: 8, pctPoss: "88.9%", ppp: 0.125, rank: "-", rating: "-", fgm: 0, fga: 4, fgPct: 0.0 }
    ],
    status: "Scout",
    sourceLinks: [
