        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 border-b border-[#141414]/10 pb-8 gap-6 no-print">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <button 
              ...
              className="flex items-center gap-2 bg-white border border-[#141414]/10 px-6 py-3 rounded-2xl font-sans text-[10px] font-bold uppercase tracking-widest hover:bg-[#141414] hover:text-[#E4E3E0] transition-all duration-300 shadow-sm no-print"
            >
                          ...
                          <div key={i} className="bg-white p-6 rounded-3xl border border-black/5 shadow-sm space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div>
                                ...
                                <p className="font-mono text-sm font-black">{stat.fgPct}%</p>
                              </div>
                            </div>
                          </div>
                        ))}
