  ...
  const filteredPlayers = useMemo(() => {
    const filtered = players.filter(p => {
      ...
      const matchesFilter = 
        ...
        p.status === posFilter ||
        (posFilter.startsWith("stars-") && p.stars === parseFloat(posFilter.split("-")[1]));
          ...
          <div className="relative group">
            ...
            >
              ...
              <optgroup label="Stars">
                <option value="stars-5">5 Stars (WNBA/Pro)</option>
                <option value="stars-4">4 Stars (Euro/Top NCAA)</option>
                <option value="stars-3">3 Stars (Mid-Major)</option>
                <option value="stars-2.5">2.5 Stars (Low-Major/DII)</option>
              </optgroup>
            </select>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredPlayers.map((p) => (
          ...
          >
                ...
                <div className="flex gap-0.5 mb-1">
                  {[...Array(5)].map((_, i) => {
                    ...
                    if (i + 1 <= starValue) {
                      ...
                      return <Star key={i} className="w-3 h-3 text-black/10" />;
                    }
                  })}
                </div>
            ...
            {p.stats.leagueLabel && (
              <div className="mb-4 p-3 bg-black/[0.03] rounded-xl border border-black/5">
                <p className="font-sans text-[8px] font-bold uppercase opacity-40 mb-2 tracking-widest">{p.stats.leagueLabel} Stats</p>
                <div className="grid grid-cols-4 gap-2">
                  <div className="flex flex-col">
                    <span className="font-mono text-[10px] font-bold">{p.stats.ppg}</span>
                    <span className="font-sans text-[7px] uppercase opacity-40">PTS</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="font-mono text-[10px] font-bold">{p.stats.rpg}</span>
                    <span className="font-sans text-[7px] uppercase opacity-40">REB</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="font-mono text-[10px] font-bold">{p.stats.apg}</span>
                    <span className="font-sans text-[7px] uppercase opacity-40">AST</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="font-mono text-[10px] font-bold">{p.stats.spg}</span>
                    <span className="font-sans text-[7px] uppercase opacity-40">STL</span>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="p-6 md:p-8 scouting-report-page">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 mb-1">
                  ...
                  <div className="flex gap-1 no-print">
                    {[...Array(5)].map((_, i) => {
                      const starValue = player.stars || 3;
                      if (i + 1 <= starValue) {
                        ...
                        return <Star key={i} className="w-5 h-5 text-black/10" />;
                      }
                    })}
                  </div>
                  {player.skillMatrix && (
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-1 font-mono text-xs opacity-60 uppercase tracking-tight mb-4">
                  ...
                  <div className="flex items-center gap-1 font-bold text-[#141414]"><Zap className="w-3 h-3" /> {player.handedness || "TBD"}</div>
                ...
                {player.videoUrl && (
                  <a 
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-6 inline-flex items-center gap-2 bg-[#141414] text-[#E4E3E0] px-6 py-3 rounded-2xl font-sans text-[10px] font-bold uppercase tracking-widest hover:bg-opacity-80 transition-all shadow-xl no-print"
                  >
                    <Play className="w-4 h-4" /> Watch Video Highlights
                  </a>
                )}
              </div>
            ...
            <div className={cn(
              ...
              <div className="space-y-8">
                ...
                <div>
                  <SectionHeader title={player.stats.leagueLabel ? `${player.stats.leagueLabel} Snapshot` : "Season Snapshot"} icon={BarChart3} />
                ...
                <div className="bg-[#141414] text-[#E4E3E0] p-8 rounded-[2rem] shadow-xl border border-white/10">
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    <div>
                      <span className="block font-sans text-[15px] font-black uppercase text-white mb-2 tracking-widest">Level</span>
                      <span className="block font-sans text-2xl font-black uppercase text-white">{player.projection.level}</span>
                    </div>
                    <div>
                      <span className="block font-sans text-[15px] font-black uppercase text-white mb-2 tracking-widest">Role</span>
